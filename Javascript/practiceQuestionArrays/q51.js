...
function chainFactor(arr) {
    for(i=0; i<arr.length; i++){
       if(arr[i+1]%arr[i] != 0 && i<arr.length-1){
            return false;
       }
    }
    return true;
...
console.log("[2,4,8,16,32] -> ",chainFactor([2,4,8,16,32]));
console.log("[2,4,8,16,32,64] -> ",chainFactor([2,4,8,16,32,64]));
console.log("[2,4,8,16,32,68] -> ",chainFactor([2,4,8,16,32,68]));